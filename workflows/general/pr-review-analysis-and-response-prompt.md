...
```
[PROJECT_ROOT]/.engineering/artifacts/reviews/[FEATURE_AREA]/[YYYY-MM-DD]-pr[PR_NUMBER]-review-analysis-and-responses.md
```

**Examples:**
- For feature-specific reviews: `.engineering/artifacts/reviews/[feature-name]/[YYYY-MM-DD]-pr[PR_NUMBER]-review-analysis-and-responses.md`
- For general features: `.engineering/artifacts/reviews/[YYYY-MM-DD]-pr[PR_NUMBER]-review-analysis-and-responses.md`
