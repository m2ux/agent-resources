...
This guide parallels the [GitHub Issue Creation Guide](github-issue-creation.guide.md) but is tailored for Jira and uses the Atlassian MCP server tools for issue creation.
...
[One sentence capturing the core objective]
...
h3. US-1: [Story Title]
{quote}As a [persona], I want [capability] so that [benefit].{quote}
...
* Defect no longer occurs following reproduction steps
* [Additional criteria]
```
...
[Describe the user need and why it matters]
...
* [Desired capability 2]

h2. Goal

[One sentence user-centric objective]
...
[What technical outcome is needed and why]
...
- [GitHub Issue Creation Guide](github-issue-creation.guide.md) - For GitHub-hosted projects
- [Architecture Review Guide](architecture-review.guide.md) - For documenting design decisions
- [PR Description Guide](pr-description.guide.md) - For describing implementations
