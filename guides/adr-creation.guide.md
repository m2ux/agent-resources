...
[Brief overview of the situation requiring a decision]
...
*Include when architectural characteristics drive the decision*
...
- ✅ [Advantage 1]
- ❌ [Disadvantage 1]
- ❌ [Why not selected - the blocking factor]
...
Implement **Option 1: [Name]** because [rationale].
...
*Include when this decision relates to other ADRs*

- [ADR: Related Decision](adr-related-decision.md) - [Relationship explanation]
...
*Include for decisions requiring ongoing enforcement*

**Governance level:**
- [ ] Project-level | [ ] Team-level | [ ] Organization-level
...
- [ADR: Related Decision](adr-related-decision.md)
